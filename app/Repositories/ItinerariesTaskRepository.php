...
use App\Repositories\Interfaces\ItinerariesTaskRepositoryInterface;
 ...
 *
 */
class ItinerariesTaskRepository implements ItinerariesTaskRepositoryInterface
{
    private $model;

    public function __construct(ItinerariesTaskInterface $model)
    {
        $this->model = $model;
    }
