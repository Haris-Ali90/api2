...
class ZoneSchedulenewResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        $endDate=  $endDate->timestamp;
            ...
            $startDateConversion=convertTimeZone($startDate,$this->timezone,'UTC','Y-m-d H:i:s');
            $endDateConversion=convertTimeZone($endDate,$this->timezone,'UTC','Y-m-d H:i:s');
    ...
    //$joeys=JoeysZoneSchedule::where('zone_schedule_id','=',$this->id)->whereNull('deleted_at')->get();
        ...
        return [
            'id' =>$this->id,
            'num' =>'SH-'.$this->id,
            'start_date' =>  $startDateConversion,
            'end_date' => $endDateConversion,
